...
namespace BackESPD.Application.Features.Authenticate.ResetPasswordCommand
{
    public class ResetPasswordCommand : IRequest<GenericResponse<bool>>
    {
        public string Email { get; set; }
    }

    internal class UpdateUsersHandler : IRequestHandler<ResetPasswordCommand, GenericResponse<bool>>
    {
